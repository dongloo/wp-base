...
<p><?php printf( esc_html__( 'Thông báo cho bạn biết &mdash; đơn hàng #%1$s thuộc %2$s đã bị hủy:', 'woocommerce' ), esc_html( $order->get_order_number() ), esc_html( $order->get_formatted_billing_full_name() ) ); ?></p>
