	...
	<div class="woocommerce-terms-and-conditions-wrapper">
		<?php
			...
			if($page_id){
				...
				echo '<div class="owl-checkout-rule">';
				echo '<div class="owl-checkout-rule-header">';
				echo get_the_title($page_id);
				echo '</div>';
				echo '<div class="owl-checkout-rule-body custom-scrollbar">';
				echo '<div class="owl-checkout-rule-body-inner">';
				echo $content;
				echo '</div>';
				echo '</div>';
				echo '</div>';
