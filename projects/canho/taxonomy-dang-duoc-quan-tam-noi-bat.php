...
?>
            ...
            <div class="flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-6">
                    <form class="filter-group" id="meta-filter-form" action="<?php echo esc_url($archive_url)?>" method="get">
                        <?php get_template_part('template-parts/filter-projects', null, array('meta' => 'thuoc-du-an-landing')); ?>
    ...
    <section class="py-8">
        <div class="container">
            <div class="flex flex-col gap-6">
                <div class="font-medium"><?php echo $count; ?> chủ đề đang được quan tâm</div>
                <?php if (have_posts()) : ?>
