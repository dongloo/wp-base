...
<?php if (have_posts()) : ?>
    <?php while (have_posts()) : the_post(); setpostview(get_the_id()); ?>
        ...
        ?>     
        <section class="ddqt-header">
            <div class="ddqt-header-title">
                <div class="container">
            ...
            <?php if (has_post_thumbnail( get_the_ID()) ): ?>
                    <?php owlGetPostThumb(get_the_ID(),'large','ddqt-thumb', true, '', false); ?>
            <?php endif; ?>
        </section>
        <section class="py-8 ddqt-main custom-banner-all">
            <div class="container">
                            ...
                            <div class="news-related pt-6 border-0 border-t border-solid border-gray">
                                <div class="flex flex-col gap-6">
                                    <h2 class="mb-0 text-heading-sm font-semibold">
                                        Các chủ đề đang được quan tâm khác
                                    </h2>
                                    <div class="grid grid-cols-1 sm:grid-có-2 md:grid-cols-3 gap-4">
                                    <?php while ($my_query->have_posts()) : $my_query->the_post(); setup_postdata($post); ?>
