<div class="modal fade" id="modal-reset-password" tabindex="-1" aria-labelledby="modal-reset-passwordLabel" aria-hidden="true">
                                ...
                                <form action="" class="flex flex-col gap-4 items-center w-full">
                                    ...
                                    <div class="flex flex-col gap-4 w-full">
                                        <div class="theme-form-group">
                                            <label for="" class="theme-form-label">Nhập mã</label>
                                            <input type="text" class="theme-form-control" required value="" placeholder="Gồm 6 số">
                                        </div>
                                    </div>
                                    <div class="flex flex-col gap-3 w-full pt-2">
                                        <button type="button" class="theme-btn btn-primary btn-block" data-bs-target="#modal-set-password" data-bs-toggle="modal">
                                            <div class="btn-text">Tiếp tục</div>
                                        </button>
                                    </div>
                                </form>                                
                            </div>
